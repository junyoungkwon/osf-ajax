...
public class UploadFile {
	...
	private static final int MOMORY_SIZE = 10 * 1024 * 1024;
	private static final int TOTAL_SIZE = 10000 * 1024 * 1024;
	private static final int FILE_SIZE = 5000 * 1024 * 1024;
	...
	static {
		DFI_FACTORY.setSizeThreshold(MOMORY_SIZE);
